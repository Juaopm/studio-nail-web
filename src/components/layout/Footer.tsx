...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-zinc-900 text-zinc-300 border-t border-rose-900/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-12">
          {/* Coluna 1: Sobre a Marca */}
          <div className="space-y-4">
            <h3 className="text-lg font-light tracking-widest text-white uppercase">
              Studio <span className="font-semibold text-rose-400">Nail</span>
            </h3>
            ...
            <div className="flex items-center space-x-4 pt-2">
              <a
                ...
                className="w-10 h-10 rounded-full bg-zinc-800 flex items-center justify-center text-zinc-300 hover:bg-rose-500 hover:text-white transition-all duration-300"
        ...
        <div className="mt-12 pt-8 border-t border-zinc-800 flex flex-col sm:flex-row items-center justify-between text-xs text-zinc-500 gap-4">
          ...
          <p className="flex items-center gap-1">
            Desenvolvido com{" "}
            <Heart size={14} className="text-rose-500 fill-rose-500" /> por{" "}
