...
export const Footer: React.FC = () => {
  return (
    <motion.footer
      ...
      className="bg-zinc-950 text-zinc-300 border-t border-[#D4AF37]/20"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
            ...
            <div className="flex items-center space-x-4 pt-2">
              <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-zinc-900 flex items-center justify-center text-zinc-300 hover:bg-[#D4AF37] hover:text-zinc-950 transition-colors duration-300"
        ...
        <div className="mt-12 pt-8 border-t border-zinc-900 flex flex-col sm:flex-row items-center justify-between text-xs text-zinc-500 gap-4">
          <p>
            © {new Date().getFullYear()} MA Machado Nails. Todos os direitos
            reservados.
          </p>
